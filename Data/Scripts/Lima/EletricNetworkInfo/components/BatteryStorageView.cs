...
namespace Lima
{
  public class BatteryStorageView : View
  {
    public float Value;
    ...
    private View _overloadView;
    private Label _overloadLabel;
    private View _timeLeftView;
    ...
    {
      _progressBar = new ProgressBar(0, MaxValue, true);
      ...
      _overloadLabel = new Label("OVERLOAD", 0.35f, TextAlignment.CENTER);
      _overloadView.AddChild(_overloadLabel);

      _timeLeftView = new View();
      ...
      _timeLeftLabel = new Label("00.0h", 0.4f, TextAlignment.CENTER);
